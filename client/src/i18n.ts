...
export const translations = {
  pt: {
    ...
    onboardingTitle: "Como usar com vídeo",
    onboardingStep1: "Pause o vídeo",
    onboardingStep2: "Aponte a câmera para o rosto",
    onboardingStep3: "Toque na mira para identificar",
    onboardingAlt: "Ou envie um print do vídeo",
    ...
    pickPersonTitle: "Quem é?",
    pickPersonHint: "Escolha a pessoa mais provável:",
  ...
  en: {
    ...
    onboardingTitle: "How to use with video",
    onboardingStep1: "Pause the video",
    onboardingStep2: "Point the camera at the face",
    onboardingStep3: "Tap the sight to identify",
    onboardingAlt: "Or upload a video screenshot",
    ...
    pickPersonTitle: "Who is it?",
    pickPersonHint: "Pick the most likely person:",
