...
export const translations = {
  pt: {
    ...
    cropTitle: "Enquadrar o rosto",
    cropHint: "Arraste e use o zoom para centralizar o rosto no círculo",
    cropZoom: "Zoom",
    cropConfirm: "Identificar",
    cropSkip: "Usar foto inteira",
    cropCancel: "Cancelar",
    modeStrict: "Rigoroso",
    modeCurious: "Curioso",
    modeLabel: "Modo",
    uncertainBadge: "Incerto",
  },
  en: {
    ...
    cropTitle: "Frame the face",
    cropHint: "Drag and zoom to center the face in the circle",
    cropZoom: "Zoom",
    cropConfirm: "Identify",
    cropSkip: "Use full photo",
    cropCancel: "Cancel",
    modeStrict: "Strict",
    modeCurious: "Curious",
    modeLabel: "Mode",
